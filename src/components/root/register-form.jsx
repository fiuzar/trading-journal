                    ...
                    <div>
                        <div className="grid gap-6">
                            <div className="grid gap-6">
                                ...
                                <div className="grid gap-3">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Button onClick={get_otp} variant="ghost" className={`text-xs cursor-pointer ${!email && "cursor-not-allowed opacity-50"}`} disabled={!email}>
                                            Get OTP
                                        </Button>
                                    </div>
                            ...
                            <div className="flex flex-col gap-4">
                                <Button onClick={handle_submit} disabled={process.env.NODE_ENV == "production"} variant="outline" className="w-full">
